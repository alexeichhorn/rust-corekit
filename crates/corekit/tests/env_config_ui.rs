...
fn main() -> ui_test::color_eyre::Result<()> {
    ...
    config.filter_files = vec![
        ...
        "env_config_vec_rules.rs".into(),
        "env_config_numeric_rules.rs".into(),
        ...
        "fail_env_config_attribute_enum.rs".into(),
        "fail_env_config_attribute_tuple_struct.rs".into(),
        "fail_env_config_attribute_unit_struct.rs".into(),
        "fail_env_config_generic_struct.rs".into(),
        "fail_env_config_global_string_name.rs".into(),
        "fail_env_config_dotenv_invalid_value.rs".into(),
        ...
        "fail_env_config_vec_rules.rs".into(),
        "fail_env_config_min_non_numeric.rs".into(),
        "fail_env_config_max_non_numeric.rs".into(),
        "fail_env_config_min_non_numeric_literal.rs".into(),
